...
// Shows 3 quick numbers computed from the plans list.
// Purely derived from the data passed in, so it stays correct
// once you swap in real data from your database.
