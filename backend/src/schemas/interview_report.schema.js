...
export const reportTechQuestionsSchema = z.object({
  technicalQuestions: z.array(
      z.object({
        ...
        interviewerIntent: z.string().describe(
...
export const reportGapsAndPlanSchema = z.object({
  preparationGaps: z
    .array(
      z.object({
        ...
        gapSeverity: z.enum(SEVERITY_LEVELS).describe(
  ...
  preparationPlan: z.array(
      z.object({
        dayNumber: z.number().describe('The day number of the preparation plan, starting from 1'),
        dailyFocus: z.string().describe(
            'The main focus of this day in the preparation plan, eg data structures, mock interviews, system design'
          ),
        dailyTasks: z.array(z.string()).describe(
  ...
  learningResources: z.array(
      z.object({
        requirementName: z.string().describe('The name of the skill/technology gap'),
        resources: z.array(
            z.object({
              resourceTitle: z.string().describe('Title of the documentation, course, or tutorial'),
              resourceUrl: z.string().describe('The exact URL link found in the search results'),
              resourceSnippet: z.string().describe('Brief description of what this resource covers')
            })
